system.register("http/ws/connection", ["node/net", "node/events", "node/http", 'node/crypto'], function(system,module) {
    var net_1, events_1, http_1, CRYPTO;
    var WsOpCode = new (function WsOpCode(){
        this[this.CHUNK = 0] = "CHUNK";
        this[this.TEXT = 1] = "TEXT";
        this[this.BINARY = 2] = "BINARY";
        this[this.CLOSE = 8] = "CLOSE";
        this[this.PING = 9] = "PING";
        this[this.PONG = 10] = "PONG";
    })();
    module.define("enum", WsOpCode)
    module.export("WsOpCode", WsOpCode);
    var WsState = new (function WsState(){
        this[this.CONNECTING = 0] = "CONNECTING";
        this[this.OPEN = 1] = "OPEN";
    })();
    module.define("enum", WsState)
    module.export("WsState", WsState);
    var WsFrame = (function (__super) {
        ...
        WsFrame.__initializer = function(__parent){
            __super=__parent;
    ...
    module.define('class', WsFrame);
    module.export("WsFrame", WsFrame);
    var WsError = (function (__super) {
        WsError.prototype.toString = function () {
            return this.code + " " + this.message;
        };
        WsError.__initializer = function(__parent){
            __super=__parent;
        };
        return WsError;
        function WsError(code, message) {
            __super.call(this, message);
            this.code = code;
        }
    })();
    module.define('class', WsError);
    module.export("WsError", WsError);
    var WsConnection = (function (__super) {
        ...
        WsConnection.__initializer = function(__parent){
            __super=__parent;
        };
        return WsConnection;
            ...
            Object.defineProperty(this, 'socket', {
                ...
                set: function (v) {
                    v.on('close', function (ok) {
                        _this.onClose(new Buffer(ok ? "0001" : "0000", 'hex'));
                    });
    ...
    module.define('class', WsConnection);
    module.export("WsConnection", WsConnection);
    return {
        setters:[
            function (net_1_1) {
                net_1 = net_1_1;
        ...
        execute: function() {
            WsFrame = module.init(WsFrame);
            WsError = module.init(WsError,Error);
            WsConnection = module.init(WsConnection,events_1.EventEmitter);
        }
    }
});
