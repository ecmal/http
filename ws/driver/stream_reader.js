system.register("http/ws/driver/stream_reader", [], function(system,module,jsx) {
    var StreamReader = (function (__super) {
    ...
    module.define('class', StreamReader);
    module.export("StreamReader", StreamReader);
    return {
        setters:[],
        execute: function() {
            StreamReader = module.init(StreamReader);
        }
    }
});
