system.register("http/ws/extensions/deflate-pm/session", ["node/zlib", "./common"], function(system,module,jsx) {
    var zlib, common_1;
    var Session = (function (__super) {
        Session.prototype.processIncomingMessage = function (message, callback) {
            ...
            var inflate = this._getInflate(), chunks = [], length = 0;
            var self = this;
            if (this._inflate) {
                this._lockIn = true;
            }
            ...
            inflate.flush(function () {
                message.data = common_1.Common.concat(chunks, length);
        ...
        Session.prototype.processOutgoingMessage = function (message, callback) {
            ...
            var deflate = this._getDeflate(), chunks = [], length = 0;
            var self = this;
            if (this._deflate) {
                this._lockOut = true;
            }
            ...
            var onFlush = function () {
                var data = common_1.Common.concat(chunks, length);
        ...
        function Session(options) {
            this._level = common_1.Common.fetch(options, 'level', zlib.Z_DEFAULT_LEVEL);
            this._memLevel = common_1.Common.fetch(options, 'memLevel', zlib.Z_DEFAULT_MEMLEVEL);
            this._strategy = common_1.Common.fetch(options, 'strategy', zlib.Z_DEFAULT_STRATEGY);
            this._acceptNoContextTakeover = common_1.Common.fetch(options, 'noContextTakeover', false);
            this._acceptMaxWindowBits = common_1.Common.fetch(options, 'maxWindowBits', undefined);
            this._requestNoContextTakeover = common_1.Common.fetch(options, 'requestNoContextTakeover', false);
            this._requestMaxWindowBits = common_1.Common.fetch(options, 'requestMaxWindowBits', undefined);
            this._queueIn = [];
            this._queueOut = [];
        }
    })();
    module.define('class', Session);
